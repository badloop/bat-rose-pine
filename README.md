...
<p align="center">A calming, tasteful theme for the [`bat`](https://github.com/sharkdp/bat) syntax-highlighting pager, based on the delightful [Rose Pine](https://rosepinetheme.com) palette.</p>
